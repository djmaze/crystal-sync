struct Db::Value
  ...
  @string_value : String?
  @time_value : Time?
  @int_value : Int16 | Int32 | Int64 | UInt32?
  @bool_value : Bool?
  ...
  def initialize(int : Int16 | Int32 | UInt32 | Int64)
    @kind = :int
    @int_value = int
  end
  ...
  def to_msgpack(packer : MessagePack::Packer)
    ...
    when :time then @time_value.as(Time).to_msgpack(Time::Format::ISO_8601_DATE_TIME, packer)
