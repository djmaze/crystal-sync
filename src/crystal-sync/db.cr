...
class Db
  ...
  delegate :tables, :clear!, :dump_schema, :escape_table_name, :get_array_fields, :load_schema, :defer_fk_constraints, :offset_sql, :placeholder_type, :primary_key_for_table, :table_as_csv, :table_from_csv, to: @driver
